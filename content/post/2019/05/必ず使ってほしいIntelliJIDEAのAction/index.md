...
thumbnailImage: images/cover/2019-05-16.jpg
categories:
  - engineering
tags:
  - idea
...
{{<himg "resources/20190518_8.gif">}}

### プロジェクト内のシンボル検索

* {{<icon "comment">}} `『XXXって名前のクラス/関数/変数がどこかにあると思うんですが..』`
* {{<icon "cog">}} `Main menu | Navigate | Go to Symbol...`
* {{<icon "keyboard">}} `Ctrl+j s`

クラスやインタフェース、関数、変数などのシンボルに対して検索できます。

{{<himg "resources/20190518_13.gif">}}

{{<history "2020-09-07: 項目を追加">}}
