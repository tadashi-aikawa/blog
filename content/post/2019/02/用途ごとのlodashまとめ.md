...
引数が配列(`T[]`)、可変長引数(`...T`)、どちらかの違いです。

#### Objectにグルーピング `(Array(n), Array(n)) -> Object`
...
#### Objectにネストプロパティ有効でグルーピング `(Array(n), Array(n)) -> Object`
